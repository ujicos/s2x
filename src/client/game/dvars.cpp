...
namespace dvars
{
	...
	std::string dvar_get_domain(const game::DvarType type, const game::DvarLimits& domain)
	{
		...
		case game::DvarType::DVAR_TYPE_BOOL_PROTECTED:
			return "Domain is 0 or 1"s;

		case game::DvarType::DVAR_TYPE_FLOAT:
		case game::DvarType::DVAR_TYPE_FLOAT_PROTECTED:
		...
		case game::DvarType::DVAR_TYPE_FLOAT_2:
			return dvar_get_vector_domain(2, domain);

		case game::DvarType::DVAR_TYPE_FLOAT_3_COLOR:
		case game::DvarType::DVAR_TYPE_FLOAT_3:
			return dvar_get_vector_domain(3, domain);

		case game::DvarType::DVAR_TYPE_FLOAT_4:
			return dvar_get_vector_domain(4, domain);

		case game::DvarType::DVAR_TYPE_INT:
		case game::DvarType::DVAR_TYPE_INT_PROTECTED:
		...
		case game::DvarType::DVAR_TYPE_COLOR:
		...
		case game::DvarType::DVAR_TYPE_STRING:
